 ...
 * Personalized by/for Luke Mullikin 2025
 ...
 * |  `   |   Q  |   W  |   F  |   P  |   B  |                    |   J  |   L  |   U  |   Y  |   ;  |  '   |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | TAB  |   A  |   R  |   S  |   T  |   H  |-------.    ,-------|   M  |   N  |   E  |   I  |   O  | Bksp |
 * |------+------+------+------+------+------|  MUTE |    | QWERT |------+------+------+------+------+------|
 * |LShift|   Z  |   X  |   C  |   D  |   V  |-------|    |-------|   K  |   H  |   ,  |   .  |   /  |RShift|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LCtr | LAlt |LOWER | /Enter  /       \Enter \  |Space |RAISE | RAlt | RCtl |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_COLEMAK_DH] = LAYOUT(
  ...
  KC_TAB,   KC_A,   KC_R,    KC_S,    KC_T,    KC_H,                      KC_M,    KC_N,    KC_E,    KC_I,    KC_O,  KC_BSPC,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_MUTE, TO(_QWERTY),KC_K,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                  KC_LGUI, KC_LCTL, KC_LALT, MO(3),  MO(2),     KC_ENT,  KC_SPACE, MO(4), KC_RCTL, KC_RALT
),
/*
 * QWERTY
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_TRNS,     TO(_COLEMAK_DH), KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [_COLEMAK_DH] = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD), ENCODER_CCW_CW(KC_WH_D, KC_WH_U) },
